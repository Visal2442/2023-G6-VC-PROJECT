        ...
        <div fluid class="d-flex">
            <v-seet class="d-flex flex-column flex-1 w-100 justify-center bg-green aling-center" elevation="4">
                ...
                <div class="our-phone d-flex flex-column mb-9 ml-16 mr-10">
                    ...
                    <p>BP511 St. 371 Phum Tropeang Chhuk (Borey Sorla), Sangkat Tek Thla, Khan Sen Sok, Phnom Penh, CAMBODIA
                    </p>
                </div>
            ...
            <v-sheet class="m-10 w-100 bg-white pa-8 " elevation="4">
                <TheTransition id="transition">
                    <v-alert class="mr-5" v-model="alert" width="40%" type="success" icon="$success" title="Successful !"
                        text="Your request was successfully!" closable></v-alert>
                </TheTransition>

                            ...
                            <tr class="" v-for="property of properties" :key="property.id">
                                ...
                                <td>
                                    <div class=" d-flex align-center">
                                        <v-icon class="mdi mdi-pencil mr-1" size="small" @click="editProperty(property.id)"></v-icon>
                                        <v-icon class="mdi mdi-delete" size="small" color="red" @click="deleteProperty(property.id)"></v-icon>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
        ...
        <v-dialog v-model="dialog" width="40%">
            <v-card>
                <v-sheet class="m-10 w-100 bg-white pa-8" elevation="4">
                    <v-card-title align="center" class="text-green text-h4 mb-5 font-weight-bold">EDITE
                    ...
                    <v-form fast-fail x="d-flex flex-column">
                        ...
                        <div class="d-flex">
                            ...
                            <v-file-input label="Choose an image" id="image-file-input" name="image" variant="outlined"
                                clearable color="green-accent-4" accept="image/*" placeholder="Image"></v-file-input>
                        </div>
                        <div class="d-flex">

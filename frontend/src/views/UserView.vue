<template>
  <div>
                ...
                <tr v-for="user of users" :key="user">
                  ...
                  <td>
                    <div class="d-flex align-center">
                      <v-avatar>
                        <v-img
                          :src="require('../assets/profile2.jpeg')"
                          width="60"
                        ></v-img>
                      </v-avatar>
                      <div class="ml-2">
                  ...
                  <td>
                    <div class="d-flex">
                      <v-card-subtitle
                        class="pa-0 bg-green-lighten-4 text-green-darken-1 px-2 py-1 rounded-xl font-weight-bold"
    ...
    <!-- Delete user dialog  -->
    <v-dialog v-model="deleteUser" width="25%">
      <v-card>

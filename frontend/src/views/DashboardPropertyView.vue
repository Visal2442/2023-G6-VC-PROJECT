                            ...
                            <tr class="" v-for="property of props.properties" :key="property.id">
                                ...
                                <td>
                                    <div class="d-flex align-center">
                                        <v-icon class="mdi mdi-pencil mr-1" size="small"
                                            @click="editProperty(property.id)"></v-icon>
                                        <v-icon class="mdi mdi-delete" size="small" color="red"
                                            @click="deleteDialogProperty()"></v-icon>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
